<html>
    ...
    <body>
        ...
        <g:each in="${extraParameters}" status="i" var="extraParameter">
            ...
            <g:if test="${extraParameter.type == 'boolean'}"><input id='extra_${extraParameter.name?.encodeAsHTML()}' name='extra_${extraParameter.name?.encodeAsHTML()}' type='checkbox'<g:if test="${extraParameter.defaultValue == 'true'}"> checked</g:if>></g:if>
