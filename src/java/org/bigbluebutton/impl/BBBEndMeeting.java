...
public class BBBEndMeeting implements BBBCommand {

    private static final Logger log = Logger.getLogger(BBBEndMeeting.class);

    private static final String ACTION = "Ending meeting";

    public BBBEndMeeting(BBBProxy proxy, Map<String, String> params){
        this.proxy = proxy;
        this.params = params;
    }
